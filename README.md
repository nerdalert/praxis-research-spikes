...
| [llm-d Praxis Benchmarking](demo/llm-d-benchmarks/) | Benchmarks the Praxis-native llm-d request path against generic Praxis proxying and the Envoy plus Go EPP baseline with mock and llm-d-inference-sim backends. |
